...
import { FaEdit, FaTrash, FaPlus, FaSearch, FaFilter, FaTimes, FaSave } from 'react-icons/fa';
  ...
  const handleSaveEdit = async () => {
    ...
    try {
      ...
      setProducts(products.map(p =>
        p.id === selectedProduct.id ? editedProduct : p
      ));
                ...
                <tbody className="divide-y divide-gray-200">
                  {filteredProducts.map((product) => (
                    <tr key={product.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center">
                          <span className={`px-2 py-1 text-xs rounded ${product.stock > 10 ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}>
                            {product.stock} units
                          </span>
                        </div>
                      </td>
