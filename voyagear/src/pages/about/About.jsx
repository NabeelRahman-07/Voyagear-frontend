...
//       name: "Alex Rivera",
//       role: "Founder & CEO",
//       bio: "Former expedition leader with 15+ years of outdoor experience.",
//       image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",
//       expertise: ["Mountaineering", "Product Design"]
//     },
//     {
//       name: "Maya Sharma",
//       role: "Head of Operations",
//       bio: "Supply chain expert passionate about sustainable sourcing.",
//       image: "https://images.unsplash.com/photo-1494790108755-2616b612b786?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",
//       expertise: ["Sustainability", "Logistics"]
//     },
//     {
//       name: "Raj Patel",
//       role: "Product Tester",
//       bio: "Professional backpacker who's hiked over 10,000 miles worldwide.",
//       image: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",
//       expertise: ["Gear Testing", "Wilderness Survival"]
//     },
//     {
//       name: "Elena Chen",
//       role: "Customer Experience",
//       bio: "Ensures every adventurer gets personalized gear recommendations.",
//       image: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",
//       expertise: ["Customer Service", "Gear Consultation"]
//     }
//   ];

//   // Milestones
//   const milestones = [
//     { year: "2020", event: "Founded with a passion for outdoor adventures" },
//     { year: "2021", event: "Launched first collection of sustainable backpacks" },
//     { year: "2022", event: "Expanded to camping equipment with 10K+ customers" },
//     { year: "2023", event: "Opened first retail store in Bangalore" },
//     { year: "2024", event: "Reached 50K+ happy adventurers worldwide" }
//   ];
      ...
      <section className="py-16">
        <div className="max-w-5xl mx-auto px-4">
          ...
          >
            ...
            <p className="text-gray-600">From a simple idea to serving adventurers worldwide</p>
          </motion.div>
            ...
            {milestones.map((milestone, index) => (
              ...
              >
                ...
                {/* <div className="absolute left-1/2 transform -translate-x-1/2 z-10">
                  <div className="bg-primary text-white w-20 h-20 rounded-full flex items-center justify-center font-bold text-lg shadow-lg">
                    {milestone.year}
                  </div>
                </div> */}
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Passionate adventurers and experts dedicated to enhancing your outdoor experiences
            </p>
          </motion.div>
              ...
              >
                ...
                <div className="flex flex-wrap justify-center gap-2">
                  {member.expertise.map((skill, skillIndex) => (
                    <span key={skillIndex} className="bg-primary/10 text-primary text-xs px-3 py-1 rounded-full">
                      {skill}
                    </span>
                  ))}
                </div>
